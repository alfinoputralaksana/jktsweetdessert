      ...
      <div class="container">
        <div class="row product-detail">
          <div class="col-md-6 mb-4 mb-md-0">
            <div class="img-box">
              <img src="<?php echo e(asset($product->image ?: 'assets/images/r1.jpg')); ?>" class="img-fluid" alt="<?php echo e($product->name); ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <h3 class="price">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></h3>
              <p class="stock">Stock: <?php echo e($product->stock); ?></p>
              ...
              <?php if($product->stock > 0): ?>
                <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="mt-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>" class="form-control" style="width: 100%; max-width: 200px;">
                  </div>
                ...
                <div class="box">
                  <div class="img-box">
                    <a href="<?php echo e(route('products.show', $related->slug)); ?>">
                      <img src="<?php echo e(asset($related->image ?: 'assets/images/r1.jpg')); ?>" class="box-img" alt="<?php echo e($related->name); ?>">
                    </a>
                  </div>
                  <div class="detail-box">
                    <h5><?php echo e($related->name); ?></h5>
                    <p class="price">Rp <?php echo e(number_format($related->price, 0, ',', '.')); ?></p>
                    <a href="<?php echo e(route('products.show', $related->slug)); ?>" class="btn btn-sm btn-outline-primary">
                      View Details
                    </a>
                  </div>
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/products/show.blade.php ENDPATH**/ ?>