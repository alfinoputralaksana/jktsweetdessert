      ...
      <div class="container">
        ...
        <div class="stats-grid">
          ...
          <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($user->name); ?></div>
        ...
        <div class="orders-section">
          <div class="orders-header">
            <h3>Recent Orders</h3>
            <a href="<?php echo e(route('orders.history')); ?>" class="btn-secondary">
              <i class="fa fa-history" aria-hidden="true"></i>
              View All History
            </a>
          </div>
              ...
              <table class="orders-table">
                ...
                <tbody>
                  <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td data-label="Order Number"><strong><?php echo e($order->order_number); ?></strong></td>
                      <td data-label="Date"><?php echo e($order->created_at->format('d M Y H:i')); ?></td>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/user/dashboard.blade.php ENDPATH**/ ?>