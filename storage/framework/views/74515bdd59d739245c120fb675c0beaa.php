      ...
      <div class="container">
        ...
        <div class="stats-grid">
          ...
          <div class="stat-card">
            ...
            <div class="stat-value">Rp <?php echo e(number_format($totalSpent, 0, ',', '.')); ?></div>
        ...
        <div class="filter-card">
          ...
          <form method="GET" action="<?php echo e(route('orders.history')); ?>">
            <div class="row">
              <div class="col-md-3 mb-3">
                <div class="form-group">
                  <label>Pencarian</label>
                  <input type="text" name="search" class="form-control" placeholder="No. Pesanan..." value="<?php echo e(request('search')); ?>">
                </div>
              </div>
              ...
              <table class="orders-table">
                ...
                <tbody>
                  <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td data-label="No. Pesanan"><strong><?php echo e($order->order_number); ?></strong></td>
                      <td data-label="Tanggal"><?php echo e($order->created_at->format('d M Y H:i')); ?></td>
                      <td data-label="Total">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></td>
                      ...
                      <td data-label="Actions">
                        <a href="<?php echo e(route('orders.show', $order->order_number)); ?>" class="btn-view">
...
<?php /**PATH C:\laragon\www\jktsweetdessert\resources\views/orders/history.blade.php ENDPATH**/ ?>