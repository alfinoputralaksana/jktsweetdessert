          ...
          <div class="col-md-4 footer-links">
            ...
            <ul>
              ...
              <?php if(auth()->guard()->check()): ?>
                <li><a href="<?php if(auth()->user()->role == 'super_admin'): ?><?php echo e(route('admin.dashboard')); ?><?php elseif(auth()->user()->role == 'karyawan'): ?><?php echo e(route('karyawan.dashboard')); ?><?php else: ?><?php echo e(route('user.dashboard')); ?><?php endif; ?>">Dashboard</a></li>
              <?php else: ?>
...
<script src="<?php echo e(asset('assets/js/jquery-3.4.1.min.js')); ?>"></script>
  ...
  </script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/partial/footer.blade.php ENDPATH**/ ?>