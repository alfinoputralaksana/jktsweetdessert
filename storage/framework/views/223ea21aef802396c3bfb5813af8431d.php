              ...
              <div class="card-body">
                ...
                <div class="text-left">
                  ...
                  <p><strong>Payment Method:</strong> 
                    <?php if($order->payment_method === 'qris'): ?>
                      QRIS / E-Wallet 
                      <?php if($order->qris_channel): ?>
                        <span class="badge badge-info"><?php echo e(strtoupper($order->qris_channel)); ?></span>
                      <?php endif; ?>
                ...
                <?php if(in_array($order->payment_method, ['qris', 'virtual_account'])): ?>
                  ...
                  <div class="alert alert-secondary" style="font-size: 11px;">
                    ...
                    <?php if($order->payment_method === 'qris'): ?>
                      QRIS Channel: <?php echo e($order->qris_channel ?? 'generic'); ?><br>
                    <?php endif; ?>
                    ...
                    <?php if($order->payment_method === 'qris'): ?>
                      ...
                      <div class="text-center my-4" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                        <h5 style="margin-bottom: 20px; color: #333;">
                          <i class="fa fa-qrcode"></i> Scan QR Code dengan <?php echo e(strtoupper($order->qris_channel ?? 'aplikasi e-wallet Anda')); ?>
                        ...
                        <div style="display: inline-block; padding: 20px; background: white; border: 3px solid #28a745; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                          ...
                          <img src="<?php echo e($qrImageUrl); ?>" 
                               alt="QRIS Code untuk <?php echo e(strtoupper($order->qris_channel ?? 'e-wallet')); ?>" 
                        ...
                        <div class="alert alert-warning mt-3" style="font-size: 13px; border-left: 4px solid #ff9800;">
                          ...
                          <strong>Penting untuk <?php echo e(strtoupper($order->qris_channel ?? 'E-wallet')); ?>:</strong>
                          <ul style="margin: 10px 0; padding-left: 20px;">
                            ...
                            <li>Pastikan aplikasi <?php echo e(strtoupper($order->qris_channel ?? 'e-wallet')); ?> sudah update ke versi terbaru</li>
                          </ul>
                        </div>
                        <div class="mt-3">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/orders/success.blade.php ENDPATH**/ ?>