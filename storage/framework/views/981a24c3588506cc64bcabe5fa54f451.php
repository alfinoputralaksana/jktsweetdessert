  ...
  <div class="hero_area">
    ...
    <section class="slider_section ">
                    ...
                    <form method="GET" action="<?php echo e(route('products.index')); ?>">
                      <div class="form-row ">
                        <div class="form-group col-lg-5">
                          <input type="text" name="search" class="form-control" id="inputProductName" placeholder="Nama Makanan" value="<?php echo e(request('search')); ?>">
                        </div>
      ...
      <div class="slider_container">
        <div class="item">
          <div class="img-box">
            <img src="<?php echo e(asset('assets/images/slider-img1.png')); ?>" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="<?php echo e(asset('assets/images/slider-img2.png')); ?>" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="<?php echo e(asset('assets/images/slider-img3.png')); ?>" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="<?php echo e(asset('assets/images/slider-img4.png')); ?>" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            ...
            <div class="top-product-card">
              ...
              <div class="detail-box">
                ...
                <div class="product-footer">
                  ...
                  <a href="<?php echo e(route('products.show', $item['product']->slug)); ?>" class="view-btn" title="Lihat Detail">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/index.blade.php ENDPATH**/ ?>