              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div id="qris-channel-selection" class="ml-4 mb-3" style="display: <?php echo e(old('payment_method') === 'qris' ? 'block' : 'none'); ?>;">
                      ...
                      <select name="qris_channel" id="qris_channel" class="form-control" style="font-size: 14px;">
                        <option value="dana" <?php echo e(old('qris_channel') === 'dana' ? 'selected' : ''); ?>>DANA - Dompet Digital (Recommended)</option>
                        <option value="gopay" <?php echo e(old('qris_channel') === 'gopay' ? 'selected' : ''); ?>>GoPay - Gojek Payment</option>
                        <option value="ovo" <?php echo e(old('qris_channel') === 'ovo' ? 'selected' : ''); ?>>OVO - OVO Wallet</option>
                        <option value="linkaja" <?php echo e(old('qris_channel') === 'linkaja' ? 'selected' : ''); ?>>LinkAja - Link Indonesia</option>
                      </select>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jktsweetdessert/resources/views/orders/checkout.blade.php ENDPATH**/ ?>